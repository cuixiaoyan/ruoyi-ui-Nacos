<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="studentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="性别" align="center" :formatter="studentSexFormat" prop="studentSex"/>
      <el-table-column label="状态" align="center" :formatter="studentStatusFormat" prop="studentStatus"/>
